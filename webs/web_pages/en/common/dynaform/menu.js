...
//	directory level: 0: directory has no branches;  1: directory level 1;  2:level 2;   and so on
	...
	"MediaServerCfgRpm",            0,      2,           str_menu.nasMediaCfg,
	...
	"RouterWithAPModeRpm",			0,		2,			str_menu.routerWithAPMode,
	...
	"pcDoExitRpm",              0,      0,          str_menu.sysLogout,
...
function menuDisplay(sessionID)
{
	var i = 0;
	var className;
	for (var n = 0; n < menuList.length; n +=4  )
