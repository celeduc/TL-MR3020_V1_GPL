...
flash_mac #define flash_mac_full_usage "flash_mac sets MAC addr
...
peek #define peek_full_usage "peek <addr> <len>
...
udhcpc [B<-Cfbnqv>] [B<-c> CLIENTID] [B<-H> HOSTNAME] [B<-i> INTERFACE]
