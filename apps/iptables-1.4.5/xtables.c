...
/* the XTABLES_LIBDIR defined by Makefile is not good, redefine here, by lqt, 2010.6.24 */
#undef 	XTABLES_LIBDIR
#define XTABLES_LIBDIR "/lib/libexec/xtables"
...
/* beacasu our route system have not modprobe programe, we have to insmod manually befor iptables run, 
 * return 0 direct here. by lqt, 2010.6.13 */
        return 0;
