...
handle_read(void *ctx, const u8 *src_addr, const u8 *buf, size_t len)
{
	...
	/* hostapd will receives multicast(01:80:C2:00:00:03) or 
	 * broadcast EAP packets that not belong to it, so drop
	 * them ,by huxiaohu, 10Jan12 
	 */	
	if (0 == (buf[0] & 0x1))
	{
