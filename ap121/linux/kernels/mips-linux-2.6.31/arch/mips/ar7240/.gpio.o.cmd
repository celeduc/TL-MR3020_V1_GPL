cmd_arch/mips/ar7240/gpio.o := mips-linux-uclibc-gcc -Wp,-MD,arch/mips/ar7240/.gpio.o.d  -nostdinc -isystem /home/project/svn/TL-MR3020_V1_GPL/build/gcc-4.3.3/build_mips/staging_dir/usr/bin/../lib/gcc/mips-linux-uclibc/4.3.3/include -Iinclude  -I/home/project/svn/TL-MR3020_V1_GPL/ap121/linux/kernels/mips-linux-2.6.31/arch/mips/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -mno-check-zero-division -mabi=32 -G 0 -mno-abicalls -fno-pic -pipe -msoft-float -ffreestanding -march=mips32r2 -Wa,-mips32r2 -Wa,--trap -I/home/project/svn/TL-MR3020_V1_GPL/ap121/linux/kernels/mips-linux-2.6.31/arch/mips/include/asm/mach-ar7240 -I/home/project/svn/TL-MR3020_V1_GPL/ap121/linux/kernels/mips-linux-2.6.31/arch/mips/include/asm/mach-generic -D"VMLINUX_LOAD_ADDRESS=0xffffffff80002000" -fno-stack-protector -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -DAP_RESET_GPIO=21 -DSYSTEM_MODE_NORMAL_ROUTER=0 -DSYSTEM_MODE_AP=1 -DSYSTEM_MODE_APC_ROUTER=2 -DSYSTEM_MODE_3G_ROUTER=3 -DSYSTEM_MODE_MAX=4 -DSYSTEM_MODE_SOFT_ENABLE=19 -DSYSTEM_MODE_SOFT_DISABLE=20 -DCONFIG_PID_MR302001=y -DGPIO_JUMPSTART_LED_BIT=26 -DGPIO_JUMPSTART_LED_ON=0 -DGPIO_INTERNET_LED_BIT=27 -DGPIO_INTERNET_LED_ON=0 -DGPIO_WLAN_LED_BIT=0 -DGPIO_WLAN_LED_ON=1 -DGPIO_RESET_FAC_BIT=11 -DGPIO_FAC_RST_HOLD_TIME=5 -DSUPPORT_HARDWARE_MULTI_MODE=y -DSYS_MODE_GPIO_1=18 -DSYS_MODE_GPIO_2=20 -DJUMPSTART_RST_MULTIPLEXED=y -DGPIO_USB_POWER_SUPPORT=8 -DGPIO_USB_POWER_ON=1 -DWPS_LED_GPIO=1 -DATH_SUPPORT_LED=1 -DGPIO_PIN_FUNC_0=0 -DGPIO_PIN_FUNC_1=0 -DGPIO_PIN_FUNC_2=0 -DMODE_AP=y -DMODE_APC_ROUTER=y -DMODE_3G_ROUTER=y   -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(gpio)"  -D"KBUILD_MODNAME=KBUILD_STR(gpio)"  -c -o arch/mips/ar7240/gpio.o arch/mips/ar7240/gpio.c

deps_arch/mips/ar7240/gpio.o := \
  arch/mips/ar7240/gpio.c \
    $(wildcard include/config/no/ethsw.h) \
    $(wildcard include/config/gpio/debug.h) \
    $(wildcard include/config/pid/mr302001.h) \
    $(wildcard include/config/pid/wr74104.h) \
    $(wildcard include/config/pid/mr322001.h) \
    $(wildcard include/config/pid/mr322002.h) \
    $(wildcard include/config/pid/wr70301.h) \
...
arch/mips/ar7240/gpio.o: $(deps_arch/mips/ar7240/gpio.o)
