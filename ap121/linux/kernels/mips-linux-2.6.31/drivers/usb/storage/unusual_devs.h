...
#if 0   //deleted by dinghongtao, it may conflict with some modem, do mode_switch just in  handle_card
...
#if 0   //deleted by dinghongtao, conflict with some modem, do mode_switch just in  handle_card
