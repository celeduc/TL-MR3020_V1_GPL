...
/*added by zb for lan&wan switch*/
#ifdef CONFIG_ATHR_PHY_SWAP
                ar7240_reg_rmw_set(AG7240_ETH_CFG, AG7240_ETH_CFG_SW_PHY_SWAP);
                ar7240_reg_rmw_set(AG7240_ETH_CFG, AG7240_ETH_CFG_SW_PHY_ADDR_SWAP);
#endif
